...
class ClassesController extends \Phalcon\Mvc\Controller {
    ...
    public function getbyid($id = null) {
        ...
        if (empty($id)):
            ...
            $collection = Classes::findFirstByid($id);
            if ($collection):
    ...
    /**
     * This function using to create Classes information
     */
    public function create() {
        ...
        $validation->add('class_name', new PresenceOf(['message' => 'class_name is required']));
        ...
        if (count($messages)):
            ...
            $collection->class_name = $input_data->class_name;
    ...
    /**
     * This function using to Classes information edit
     */
    public function update($id = null) {
        ...
        if (empty($id)):
            ...
            $validation->add('class_name', new PresenceOf(['message' => 'class_nameis required']));
