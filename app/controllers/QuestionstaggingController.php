...
class QuestionstaggingController extends \Phalcon\Mvc\Controller {
    ...
    public function getbyid($id = null) {
        ...
        if (empty($id)):
            ...
            $collection = QuestionsTagging::findFirstByid($id);
            if ($collection):
    ...
    /**
     * This function using to create QuestionsTagging information
     */
    public function create() {
        ...
        if (count($messages)):
            ...
            $collection = new QuestionsTagging();
    ...
    /**
     * This function using to QuestionsTagging information edit
     */
