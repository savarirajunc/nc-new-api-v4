...
class CoreeducationController extends \Phalcon\Mvc\Controller {
    ...
    public function getbyid($id = null) {
        ...
        if (empty($id)):
            ...
            $collection = CoreEducation::findFirstByid($id);
            if ($collection):
    ...
    /**
     * This function using to create CoreEducation information
     */
    ...
    /**
     * This function using to CoreEducation information edit
     */
